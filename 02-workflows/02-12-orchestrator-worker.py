...
def research_worker(state: WorkerState) -> OverallState:
    ...
    findings = {"worker_id": worker_id, "source": source, "content": response}
...
builder.add_conditional_edges(
    "orchestrator", create_research_workers, ["research_worker"]
)
...
result = graph.invoke({"research_topic": topic, "sources": [], "worker_findings": []})
